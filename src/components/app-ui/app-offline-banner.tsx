...
export function AppOfflineBanner({
  ...
  return (
    <div className="flex min-h-8 items-center justify-center gap-1.5 border-b border-warning-border bg-warning-soft px-3 py-1 text-xs text-warning-text" role="status">
